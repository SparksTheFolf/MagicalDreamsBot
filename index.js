...
switch(args[0]){
    ...
    switch(args[0]){
      ...
      if(msg.content === 'A113'){
            score = score+10;
            msg.delete()
            msg.author.send('You have overridden the systen).then(msg => msg.delete(30000))
            msg.author.send('Go into dev mode, contact @388716470772826112').then(msg => msg.delete(30000))
